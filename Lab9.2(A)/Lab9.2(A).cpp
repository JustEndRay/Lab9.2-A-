...
void Phys_Sort(Students* S, const int N)
{
    for (int i0 = 0; i0 < N - 1; i0++)
        ...
        {
            if ((S[i1].speciality > S[i1 + 1].speciality)||((S[i1].speciality == S[i1 + 1].speciality)
                    &&
                    (S[i1].course > S[i1+1].course))||((S[i1].speciality == S[i1 + 1].speciality)
                    &&
...
bool Bin_Search(Students* S, const int N, const string surname, const int speciality, const int course)
{
    int L = 0, R = N - 1, m;
    do
    {
